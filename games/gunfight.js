...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        if(!opponent) return;
        if(opponent.bot) return message.channel.send('You cannot fight bots!')
        message.channel.send('The blue button is for the message author, and the red one is for the person mentioned.')
		const positions = {
